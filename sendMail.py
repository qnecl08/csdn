...
class Mailer(object):
    ...
    def sendMail(self):
        ...
        # jpg类型的附件
        jpgpart = MIMEApplication(open('E:/download/python/chromedriver_win32.zip', 'rb').read())
        jpgpart.add_header('Content-Disposition', 'attachment', filename='chromedriver_win32.zip')
        msg.attach(jpgpart)
